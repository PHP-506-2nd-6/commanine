...
//   }
// }
searchBtn.addEventListener('click',throttle());
...
//           submitBtn(); // certification()실행  => 1초동안은 timer가 null이 아니기 때문에 실행이 안됨. 
//       }
//   }
// }

// // birthInput.addEventListener('click',throttleBirth());
// searchBtn.addEventListener('submit',throttle(submitBtn));