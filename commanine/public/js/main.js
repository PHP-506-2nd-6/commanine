...
(function ($) {
        ...
        if ($(this).hasClass("split")) {
            ...
            if (options.height !== "false") {
                $theSlider
                    ...
                    .css(
                        "height",
                        options.height == "full" ? "100%" : options.height
                    );
            }
            ...
            if (options.arrows == "true") {
                if (
                    !$theSlider.find("> .inner-wrapper .navigation-wrapper")
                        .length
                ) {
                    $theSlider
                        .find("> .inner-wrapper > .slides-wrapper")
            ...
            $theSlider
                .find(
                    "> .inner-wrapper > .navigation-wrapper .navigation-arrow"
                )
                .on(
                    "click",
                    {
    ...
    function splitArrows(event) {
        ...
        if ($buttonClicked.hasClass("prev")) {
            ...
            if (event.data.infinite == "true") {
                ...
                if (
                    !$currentSlide.find("> .slide.previous").last().prev()
                        .length &&
            ...
            if (
                !$currentSlide.find("> .slide.init").last().next().next().length
            ) {
                if (event.data.infinite == "true") {
                    $currentSlide.each(function () {
                        var $firstElement = $(this).find("> .slide").first();
    ...
    function splitDots(event) {
        ...
        $slides.each(function () {
            $slide.each(function () {
                var $matchedSlider = $(this).attr(
                    "data-attribute-slide-number"
                );
