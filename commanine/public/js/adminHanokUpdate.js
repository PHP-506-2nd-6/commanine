...
// 이미지 미리 보기를 표시하는 함수
    ...
    // 아코디언
        ...
        function collapse(element) {
            ...
            let before = document.getElementsByClassName("aco-active")[0];             // 기존에 활성화된 버튼
            if (before && document.getElementsByClassName("aco-active")[0] != element) {  // 자신 이외에 이미 활성화된 버튼이 있으면
