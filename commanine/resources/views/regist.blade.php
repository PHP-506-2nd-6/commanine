...
<div class="container box">
    <div class="registBox">
        ...
        <form action="{{route('users.regist.post')}}" method="post" class="form-box" id="formBox">
            @csrf
            <input type="text" onblur="checkName()" name="name" id="name" autocomplete="off" class="errbox nameInput" placeholder="이름" value="{{old('name')}}" maxlength="30">
            ...
            <input type="text" onblur="checkNum()" name="phoneNumber" autocomplete="off" id="phoneNumber" class="errbox numInput" placeholder="전화번호는 숫자만 입력해 주세요." value="{{old('phoneNumber')}}" maxlength="11">
            ...
            <div class="emailBox">
                <input type="text" name="email" onblur="checkEmail()"  class="emailInput" autocomplete="off" id="email" placeholder="이메일" value="{{old('email')}}" maxlength="30">
            ...
            <input type="password" name="password" onblur="checkPw()" autocomplete="off" id="password" placeholder="비밀번호 8~20자" class="errbox pwInput" maxlength="20">
            <div class="errmsg pwAlert">
                @if($errors->has('password'))
                    {{$errors->first('password')}}
                @endif
            </div>
            <input type="password" name="passwordChk" autocomplete="off" id="passwordChk" placeholder="비밀번호 확인" class="errbox" maxlength="20">
            ...
            <input type="text" name="questAnswer" oninput="checkAnswer()" autocomplete="off" id="questAnswer" placeholder="질문의 답" class="errbox answerInput" value="{{old('questAnswer')}}" maxlength="30">
