...
<div class="container box">
    <div class="registBox">
        ...
        <form action="{{route('users.regist.post')}}" method="post" class="form-box" id="formBox">
            ...
            <div class="emailBox">
                <input type="text" name="email" onkeyup="checkEmail()"  class="emailInput" disabled="" autocomplete="off" id="email" placeholder="이메일" value="{{old('email')}}" maxlength="30" required>
            ...
            <div class="emailChkNumBox">
                <input type="text" name="emailChkNum" onkeyup="emailNumChk()"  class="emailChkNum" autocomplete="off" id="emailChkNum" placeholder="인증번호" disabled="true" maxlength="8" required>
