...
@section('contents')
    <div class="con">
        ...
        <form action="{{route('users.findId.post')}}" method="post">
            @csrf
            <input type="text" name="name" id="name" placeholder="이름" value="{{old('name')}}" class="findInput" maxlength="30" autocomplete="off">
            <input type="text" name="phoneNumber" id="phoneNumber" placeholder="전화번호" class="findInput" maxlength="11" autocomplete="off">
            ...
            <input type="text" name="questAnswer" id="questAnswer" placeholder="질문의 답" class="findInput" maxlength="30" autocomplete="off">
            <div class="btnGroup">
