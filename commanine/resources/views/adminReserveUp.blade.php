        ...
        <div class="container col-9 content-box">
            ...
            <form action="{{ route('admin.reservation.up', ['reserve_id' => $reservations->reserve_id]) }}" method="POST">
                ...
                <div class="reserveup">
                    ...
                    <input type="text" name="reserve_name" id="reserve_name" value="{{$reservations->reserve_name}}">
                    <br>
                    <label for="reserve_num">예약자 번호</label>
                    <input type="text" name="reserve_num" id="reserve_num" value="{{$reservations->reserve_num}}">
                    <br>
                    ...
                    <br>
                    <label for="reserve_flg">예약상태</label>
